...
.dashboard .player--inner{
	padding-top:15px
}
.dashboard .player--navigation{
	margin-top:10px
}
</style>
	...
	<div class="header-aside-inner">
		...
		<?php else : ?>
			...
			<div class="bb-header-buttons">
				<a href="<?php echo site_url("login"); ?>" class="button small outline signin-button link"><?php _e( 'Sign in', 'buddyboss-theme' ); ?></a>
